            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="last_name_kana" class="col-md-4 col-form-label text-md-right">{{ __('セイ') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="first_name_kana" class="col-md-4 col-form-label text-md-right">{{ __('メイ') }}</label>

                            <div class="col-md-6">
                                <input id="first_name_kana" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name_kana" value="{{ old('first_name_kana') }}" required autocomplete="first_name_kana" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birth" type="date" min="1" class="form-control{{ $errors->has('birth') ? ' is-invalid' : '' }}" name="birth" value="{{ old('birth') }}" required>
